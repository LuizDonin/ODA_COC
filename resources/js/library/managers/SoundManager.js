class SoundManager {
    ...
    // Para todos os sons incluindo música de fundo
    static stopAllIncludingMusic() {
        try {
            ...
            console.error('Erro ao parar todos os sons incluindo música:', error);
        }
    }
    ...
    static playMusic(key, volume = 1.0) {
        ...
        // ⛔️ Já está tocando a mesma música? Não toca de novo
        if (this.backgroundMusic && this.backgroundMusic.isPlaying && this.backgroundMusic.key === key) {
            return this.backgroundMusic;
        }
    
        try {
            // Se há música tocando diferente, para ela primeiro
            ...
            // ✅ Adiciona na lista global para evitar destruição
            this.game.sound.sounds.push(this.backgroundMusic);
