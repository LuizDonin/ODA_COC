export class Boot extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.svg('btOrientacao_coc', './resources/images/hud/btOrientacao_coc.svg');
        ...
        this.load.svg('btFechar_coc', './resources/images/hud/btFechar_coc.svg');
        ...
        this.load.json('dialogos', './resources/game/data/dialogos.json');
